...
class LivreSeeder extends Seeder
{
    public function run(): void
    {
        $livres = [
            ...
            ['titre' => 'Notre-Dame de Paris',            'auteur' => 'Victor Hugo',               'disponible' => false],
            ...
            ['titre' => 'La Peste',                       'auteur' => 'Albert Camus',              'disponible' => false],
            ...
            ['titre' => 'Harry Potter et la Chambre des secrets','auteur' => 'J.K. Rowling',       'disponible' => false],
            ...
            ['titre' => 'Le Hobbit',                      'auteur' => 'J.R.R. Tolkien',           'disponible' => false],
            ...
            ['titre' => 'Brave New World',                'auteur' => 'Aldous Huxley',             'disponible' => false],
            ...
            ['titre' => 'Hunger Games',                   'auteur' => 'Suzanne Collins',           'disponible' => false],
            ...
            ['titre' => 'Gone Girl',                      'auteur' => 'Gillian Flynn',             'disponible' => false],
            ...
            ['titre' => 'Réfléchissez et devenez riche',  'auteur' => 'Napoleon Hill',             'disponible' => false],
            ...
            ['titre' => 'Clean Code',                     'auteur' => 'Robert C. Martin',          'disponible' => false],
            ...
            ['titre' => 'Le Petit Nicolas',               'auteur' => 'René Goscinny',             'disponible' => false],
            ...
            ['titre' => 'Ben-Hur',                        'auteur' => 'Lew Wallace',               'disponible' => false],
