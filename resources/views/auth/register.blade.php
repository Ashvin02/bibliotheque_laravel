    ...
    <div style="background: white; padding: 2.5rem; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); width: 100%; max-width: 420px;">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div style="margin-bottom: 1.25rem;">
                <label style="display:block; margin-bottom:0.4rem; color:#333; font-weight:600; font-size:0.9rem;">👤 Nom complet</label>
            ...
            <div style="margin-bottom: 1.25rem;">
                <label style="display:block; margin-bottom:0.4rem; color:#333; font-weight:600; font-size:0.9rem;">📧 Adresse email</label>
            ...
            <div style="margin-bottom: 1.25rem;">
                <label style="display:block; margin-bottom:0.4rem; color:#333; font-weight:600; font-size:0.9rem;">🔒 Mot de passe</label>
            ...
            <div style="margin-bottom: 1.5rem;">
                <label style="display:block; margin-bottom:0.4rem; color:#333; font-weight:600; font-size:0.9rem;">🔒 Confirmer le mot de passe</label>
        ...
        <p style="text-align:center; margin-top:1.5rem; color:#666; font-size:0.9rem;">
            Déjà un compte ? <a href="{{ route('login') }}" style="color:#4a90e2; font-weight:600; text-decoration:none;">Se connecter</a>
        </p>
    </div>
</div>
@endsection